...
# 1 "<command-line>" 2
# 1 "asm.cpp"
# 1 "/home/voffk4/cpu/ASM/Asm-header.h" 1
# 1 "/home/voffk4/cpu/config.h" 1
# 21 "/home/voffk4/cpu/config.h"
...
# 25 "/home/voffk4/cpu/config.h" 2
# 1 "/home/voffk4/cpu/onegin.h" 1




   
# 5 "/home/voffk4/cpu/onegin.h"
  int makeOneginGreatAgain(FILE* fp, FILE* out);
   int OneginTest();
# 24 "/home/voffk4/cpu/onegin.h"
   struct Line {
      char* string;
      int length;
   };
...
# 26 "/home/voffk4/cpu/config.h" 2
# 1 "/home/voffk4/cpu/stack.h" 1
...
# 16 "/home/voffk4/cpu/stack.h" 2





# 20 "/home/voffk4/cpu/stack.h"
const int POISON = 0xDEAD;
# 47 "/home/voffk4/cpu/stack.h"
    enum Error {
            OK = 0,
...
struct Stack
{
    ...
    int size;
    int capacity;
    int status; u_int64_t hash; u_int64_t chicken;
...
# 151 "/home/voffk4/cpu/stack.h"
int stackPush(Stack* stk, int value);
# 160 "/home/voffk4/cpu/stack.h"
int stackPop(Stack* stk, int* param);
...
# 2 "/home/voffk4/cpu/ASM/Asm-header.h" 2
...
# 3 "/home/voffk4/cpu/ASM/Asm-header.h" 2


# 4 "/home/voffk4/cpu/ASM/Asm-header.h"
extern FILE *listing;
extern FILE *logs;
...
int GetLine(char *arg, char *line);

int regsAndRAM(char *regsRAM, int *code_size, char *code);
# 2 "asm.cpp" 2
...
int main(void)
{
    ...
    { if (!(sourse)) { fprintf(logs, "[%s:%d] --- %s failed\n\n\n", __func__, 15, "sourse"); return ERR_INVALID_PTR; } }; { if (!(binary)) { fprintf(logs, "[%s:%d] --- %s failed\n\n\n", __func__, 16, "binary"); return ERR_INVALID_PTR; } };
    ...
    { if (!(code)) { fprintf(logs, "[%s:%d] --- %s failed\n\n\n", __func__, 24, "code"); return ERR_INVALID_PTR; } };
    ...
    for (int i = 0; i < commands.string_amount; i++)
    {
        int arg = 0;
        char regsRAM[32] = {};
        int num_args = sscanf(commands.text[i].string, "%s %d", &CMD, &arg) - 1;
...
# 85 "asm.cpp"
# 1 "/home/voffk4/cpu/commands.h" 1
if (strcmp(CMD, "IN") == 0) { if (0 == 1) { if (0 == 2) { { printf("Enter the value:\n"); int value = 0; while (scanf("%d", &value) != 1) { printf("Enter correct value (((((\n"); } stackPush(&(cpu->stk), value); }[code_size++] = 2; *((int *) ({ printf("Enter the value:\n"); int value = 0; while (scanf("%d", &value) != 1) { printf("Enter correct value (((((\n"); } stackPush(&(cpu->stk), value); } + code_size)) = arg; list(CMD, arg, { printf("Enter the value:\n"); int value = 0; while (scanf("%d", &value) != 1) { printf("Enter correct value (((((\n"); } stackPush(&(cpu->stk), value); }[code_size - 1]); code_size += sizeof(int); } } else if (0 == -1) { regsAndRAM(regsRAM, &code_size, { printf("Enter the value:\n"); int value = 0; while (scanf("%d", &value) != 1) { printf("Enter correct value (((((\n"); } stackPush(&(cpu->stk), value); }, 0); } else { { printf("Enter the value:\n"); int value = 0; while (scanf("%d", &value) != 1) { printf("Enter correct value (((((\n"); } stackPush(&(cpu->stk), value); }[code_size++] = CMD_IN; list(CMD, arg, { printf("Enter the value:\n"); int value = 0; while (scanf("%d", &value) != 1) { printf("Enter correct value (((((\n"); } stackPush(&(cpu->stk), value); }[code_size - 1]); } } else
# 10 "/home/voffk4/cpu/commands.h"
if (strcmp(CMD, "HLT") == 0) { if (0 == 1) { if (1 == 2) { { return CMD_HLT; }[code_size++] = 2; *((int *) ({ return CMD_HLT; } + code_size)) = arg; list(CMD, arg, { return CMD_HLT; }[code_size - 1]); code_size += sizeof(int); } } else if (0 == -1) { regsAndRAM(regsRAM, &code_size, { return CMD_HLT; }, 1); } else { { return CMD_HLT; }[code_size++] = CMD_HLT; list(CMD, arg, { return CMD_HLT; }[code_size - 1]); } } else


if (strcmp(CMD, "PUSH") == 0) { if (1 == 1) { if (2 == 2) { { if ((code[cpu->ip - 1] & 32) != 0) { stackPush(&(cpu->stk), cpu->regs[code[cpu->ip++]]); } else if (((code[cpu->ip - 1] & 64) != 0)) { stackPush(&(cpu->stk), cpu->RAM[code[cpu->ip++]]); } else { int value = *((int*) (code + cpu->ip)); stackPush(&(cpu->stk), value); cpu->ip += sizeof(int); } }[code_size++] = 2; *((int *) ({ if ((code[cpu->ip - 1] & 32) != 0) { stackPush(&(cpu->stk), cpu->regs[code[cpu->ip++]]); } else if (((code[cpu->ip - 1] & 64) != 0)) { stackPush(&(cpu->stk), cpu->RAM[code[cpu->ip++]]); } else { int value = *((int*) (code + cpu->ip)); stackPush(&(cpu->stk), value); cpu->ip += sizeof(int); } } + code_size)) = arg; list(CMD, arg, { if ((code[cpu->ip - 1] & 32) != 0) { stackPush(&(cpu->stk), cpu->regs[code[cpu->ip++]]); } else if (((code[cpu->ip - 1] & 64) != 0)) { stackPush(&(cpu->stk), cpu->RAM[code[cpu->ip++]]); } else { int value = *((int*) (code + cpu->ip)); stackPush(&(cpu->stk), value); cpu->ip += sizeof(int); } }[code_size - 1]); code_size += sizeof(int); } } else if (1 == -1) { regsAndRAM(regsRAM, &code_size, { if ((code[cpu->ip - 1] & 32) != 0) { stackPush(&(cpu->stk), cpu->regs[code[cpu->ip++]]); } else if (((code[cpu->ip - 1] & 64) != 0)) { stackPush(&(cpu->stk), cpu->RAM[code[cpu->ip++]]); } else { int value = *((int*) (code + cpu->ip)); stackPush(&(cpu->stk), value); cpu->ip += sizeof(int); } }, 2); } else { { if ((code[cpu->ip - 1] & 32) != 0) { stackPush(&(cpu->stk), cpu->regs[code[cpu->ip++]]); } else if (((code[cpu->ip - 1] & 64) != 0)) { stackPush(&(cpu->stk), cpu->RAM[code[cpu->ip++]]); } else { int value = *((int*) (code + cpu->ip)); stackPush(&(cpu->stk), value); cpu->ip += sizeof(int); } }[code_size++] = CMD_PUSH; list(CMD, arg, { if ((code[cpu->ip - 1] & 32) != 0) { stackPush(&(cpu->stk), cpu->regs[code[cpu->ip++]]); } else if (((code[cpu->ip - 1] & 64) != 0)) { stackPush(&(cpu->stk), cpu->RAM[code[cpu->ip++]]); } else { int value = *((int*) (code + cpu->ip)); stackPush(&(cpu->stk), value); cpu->ip += sizeof(int); } }[code_size - 1]); } } else
# 29 "/home/voffk4/cpu/commands.h"
if (strcmp(CMD, "OUT") == 0) { if (0 == 1) { if (3 == 2) { { int value = 0; stackPop(&(cpu->stk), &value); printf("%d\n", value); }[code_size++] = 2; *((int *) ({ int value = 0; stackPop(&(cpu->stk), &value); printf("%d\n", value); } + code_size)) = arg; list(CMD, arg, { int value = 0; stackPop(&(cpu->stk), &value); printf("%d\n", value); }[code_size - 1]); code_size += sizeof(int); } } else if (0 == -1) { regsAndRAM(regsRAM, &code_size, { int value = 0; stackPop(&(cpu->stk), &value); printf("%d\n", value); }, 3); } else { { int value = 0; stackPop(&(cpu->stk), &value); printf("%d\n", value); }[code_size++] = CMD_OUT; list(CMD, arg, { int value = 0; stackPop(&(cpu->stk), &value); printf("%d\n", value); }[code_size - 1]); } } else




if (strcmp(CMD, "ADD") == 0) { if (0 == 1) { if (4 == 2) { { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first + second); }[code_size++] = 2; *((int *) ({ int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first + second); } + code_size)) = arg; list(CMD, arg, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first + second); }[code_size - 1]); code_size += sizeof(int); } } else if (0 == -1) { regsAndRAM(regsRAM, &code_size, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first + second); }, 4); } else { { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first + second); }[code_size++] = CMD_ADD; list(CMD, arg, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first + second); }[code_size - 1]); } } else
...
if (strcmp(CMD, "SUB") == 0) { if (0 == 1) { if (5 == 2) { { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second - first); }[code_size++] = 2; *((int *) ({ int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second - first); } + code_size)) = arg; list(CMD, arg, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second - first); }[code_size - 1]); code_size += sizeof(int); } } else if (0 == -1) { regsAndRAM(regsRAM, &code_size, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second - first); }, 5); } else { { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second - first); }[code_size++] = CMD_SUB; list(CMD, arg, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second - first); }[code_size - 1]); } } else
...
if (strcmp(CMD, "MUL") == 0) { if (0 == 1) { if (6 == 2) { { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first * second); }[code_size++] = 2; *((int *) ({ int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first * second); } + code_size)) = arg; list(CMD, arg, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first * second); }[code_size - 1]); code_size += sizeof(int); } } else if (0 == -1) { regsAndRAM(regsRAM, &code_size, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first * second); }, 6); } else { { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first * second); }[code_size++] = CMD_MUL; list(CMD, arg, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), first * second); }[code_size - 1]); } } else
...
if (strcmp(CMD, "DIV") == 0) { if (0 == 1) { if (7 == 2) { { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second / first); }[code_size++] = 2; *((int *) ({ int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second / first); } + code_size)) = arg; list(CMD, arg, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second / first); }[code_size - 1]); code_size += sizeof(int); } } else if (0 == -1) { regsAndRAM(regsRAM, &code_size, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second / first); }, 7); } else { { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second / first); }[code_size++] = CMD_DIV; list(CMD, arg, { int first = 0; int second = 0; stackPop(&(cpu->stk), &first); stackPop(&(cpu->stk), &second); stackPush(&(cpu->stk), second / first); }[code_size - 1]); } } else
...
if (strcmp(CMD, "POP") == 0) { if (1 == 1) { if (8 == 2) { { if ((code[cpu->ip - 1] & 32) != 0) { stackPop(&(cpu->stk), &(cpu->regs[code[cpu->ip++]])); } else if ((code[cpu->ip - 1] & 64) != 0) { stackPop(&(cpu->stk), &(cpu->RAM[code[cpu->ip++]])); } else { int value = 0; stackPop(&(cpu->stk), &value); } }[code_size++] = 2; *((int *) ({ if ((code[cpu->ip - 1] & 32) != 0) { stackPop(&(cpu->stk), &(cpu->regs[code[cpu->ip++]])); } else if ((code[cpu->ip - 1] & 64) != 0) { stackPop(&(cpu->stk), &(cpu->RAM[code[cpu->ip++]])); } else { int value = 0; stackPop(&(cpu->stk), &value); } } + code_size)) = arg; list(CMD, arg, { if ((code[cpu->ip - 1] & 32) != 0) { stackPop(&(cpu->stk), &(cpu->regs[code[cpu->ip++]])); } else if ((code[cpu->ip - 1] & 64) != 0) { stackPop(&(cpu->stk), &(cpu->RAM[code[cpu->ip++]])); } else { int value = 0; stackPop(&(cpu->stk), &value); } }[code_size - 1]); code_size += sizeof(int); } } else if (1 == -1) { regsAndRAM(regsRAM, &code_size, { if ((code[cpu->ip - 1] & 32) != 0) { stackPop(&(cpu->stk), &(cpu->regs[code[cpu->ip++]])); } else if ((code[cpu->ip - 1] & 64) != 0) { stackPop(&(cpu->stk), &(cpu->RAM[code[cpu->ip++]])); } else { int value = 0; stackPop(&(cpu->stk), &value); } }, 8); } else { { if ((code[cpu->ip - 1] & 32) != 0) { stackPop(&(cpu->stk), &(cpu->regs[code[cpu->ip++]])); } else if ((code[cpu->ip - 1] & 64) != 0) { stackPop(&(cpu->stk), &(cpu->RAM[code[cpu->ip++]])); } else { int value = 0; stackPop(&(cpu->stk), &value); } }[code_size++] = CMD_POP; list(CMD, arg, { if ((code[cpu->ip - 1] & 32) != 0) { stackPop(&(cpu->stk), &(cpu->regs[code[cpu->ip++]])); } else if ((code[cpu->ip - 1] & 64) != 0) { stackPop(&(cpu->stk), &(cpu->RAM[code[cpu->ip++]])); } else { int value = 0; stackPop(&(cpu->stk), &value); } }[code_size - 1]); } } else
# 86 "asm.cpp" 2
